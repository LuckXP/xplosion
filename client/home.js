        ...
        return (
					<div className="jumbotron my-jumbotron">
					  <div className="col-xs-8">
						  <h1 className="display-3 pink">X-Plosion</h1>
						  <h3>SODA FOR SUPER HEROS</h3>
						  <p className="lead pink">Try a healthy alternative to the current artificial drinks - your mind, body and tounge will thank you!</p>
						  <hr className="m-y-2" />
